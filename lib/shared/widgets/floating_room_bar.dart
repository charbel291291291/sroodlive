...
/// minimized a room. Tapping it returns them to the room; the âœ• button
...
class _FloatingRoomBarState extends State<FloatingRoomBar>
  ...
  Future<void> _exitRoom(Room room) async {
    ...
    // X only closes the floating bar. It must not leave the room on backend.
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text(
                                context.isArabic ? 'ØºØ±ÙØ© Ù†Ø´Ø·Ø©' : 'Active Room',
                                style: TextStyle(
