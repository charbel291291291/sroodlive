...
//   avatarFillRatio  = min(openingW, openingH) * ~0.92   (avatar diameter)
...
class VipFrameLayout {
  ...
  static const Map<int, VipFrameLayout> _table = {
    1: VipFrameLayout(avatarFillRatio: 0.70, avatarDyFraction: 0.006),
    2: VipFrameLayout(avatarFillRatio: 0.54, avatarDyFraction: -0.035),
    3: VipFrameLayout(avatarFillRatio: 0.84, avatarDyFraction: 0.036),
    4: VipFrameLayout(avatarFillRatio: 0.50, avatarDyFraction: -0.058),
    5: VipFrameLayout(avatarFillRatio: 0.81, avatarDyFraction: 0.020),
    6: VipFrameLayout(avatarFillRatio: 0.60, avatarDyFraction: -0.031),
    7: VipFrameLayout(avatarFillRatio: 0.83, avatarDyFraction: -0.022),
    8: VipFrameLayout(avatarFillRatio: 0.86, avatarDyFraction: 0.013),
    9: VipFrameLayout(avatarFillRatio: 0.79, avatarDyFraction: 0.034),
  };

  /// Neutral fallback for unknown / non-VIP levels - a centred avatar that
  /// comfortably clears any frame rim.
  static const VipFrameLayout _fallback =
      VipFrameLayout(avatarFillRatio: 0.70, avatarDyFraction: 0.0);
