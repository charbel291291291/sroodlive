...
class _WithdrawalScreenState extends State<WithdrawalScreen> {
  ...
  String _method = 'bank';
  int _diamondsToWithdraw = 1000;
  bool _isLoading = false;
  bool _isSubmitted = false;
  int _availableDiamonds = 0;

  static const List<Map<String, dynamic>> _methods = [
    {'key': 'bank', 'en': 'Bank Transfer', 'ar': 'تحويل بنكي', 'icon': Icons.account_balance_rounded},
    {'key': 'paypal', 'en': 'PayPal', 'ar': 'باي بال', 'icon': Icons.payment_rounded},
    {'key': 'wise', 'en': 'Wise', 'ar': 'وايز', 'icon': Icons.swap_horiz_rounded},
  ];
  ...
  Future<void> _loadDiamonds() async {
    try {
      ...
      setState(() {
        ...
        _diamondsToWithdraw = _availableDiamonds.clamp(_minDiamonds, _availableDiamonds).toInt();
      });
    } catch (_) {}
  }
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildSectionLabel(
                          isArabic ? 'عدد الألماس للسحب' : 'Diamonds to withdraw',
                          isArabic,
                        ),
                        ...
                        const SizedBox(height: 10),
                        ..._methods.map((m) => _buildMethodTile(m, isArabic, dir)),
                        const SizedBox(height: 20),
                        _buildSectionLabel(
                        ...
                        SizedBox(
                          ...
                          height: 54,
                          child: FilledButton(
                            onPressed: _isLoading || _availableDiamonds < _minDiamonds
                                ? null
                                : _submit,
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              Text(
                isArabic ? 'حوّل الألماس إلى أموال' : 'Convert diamonds to cash',
                style: const TextStyle(
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: const Icon(Icons.diamond_rounded, color: Color(0xFFF0C15A), size: 26),
          ),
      ...
      child: Column(
        children: [
          Row(
            textDirection: isArabic ? TextDirection.rtl : TextDirection.ltr,
            children: [
              const Icon(Icons.diamond_rounded, color: Color(0xFFF0C15A), size: 20),
          ...
          SliderTheme(
            ...
            child: Slider(
              value: _diamondsToWithdraw.toDouble(),
              min: _minDiamonds.toDouble(),
              max: (_availableDiamonds > _minDiamonds
                      ? _availableDiamonds
                      : _minDiamonds)
                  .toDouble(),
  ...
  Widget _buildMethodTile(Map<String, dynamic> method, bool isArabic, TextDirection dir) {
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Icon(
              icon,
              color: selected ? const Color(0xFFF0C15A) : const Color(0xFF9E91B8),
              size: 22,
            ),
